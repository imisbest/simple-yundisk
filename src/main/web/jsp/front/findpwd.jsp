...
<div class="modal-dialog" style="margin-top: 10%;">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h1 class="modal-title text-center" id="myModalLabel">找回密码界面</h1>
        </div>
        <form action="${path}/user/findpwd" method="post">
            <div class="modal-body " id="model-body">

                <div class="form-group ">
                    <input type="password" class="form-control input-lg" placeholder="请输入新密码" autocomplete="off"
                           name="pwd">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="tel" id="phonenumber" class="form-control input-lg" placeholder="输入你的手机号"
                           autocomplete="off"
                           name="phone">
                </div>
            ...
            <button type="submit" class="btn btn-primary form-control btn-lg">点击找回密码</button>
        ...
        <div class="modal-footer">
            <div class="list-group form-group">
                <a href="${path}/jsp/front/login.jsp" class="list-group-item ">
                    <button type="button" class="btn  form-control btn-lg">返回登录</button>
                </a>
