    ...
    <script type="text/javascript">
        $(function () {
            ...
            $.post("${path}/user/getMessage", function (message) {
                ...
                if (message == null || message === "") {
                    ...
                    $.post("${path}/user/cleMessageUnLock");
        ...
        $(function () {
            $("#phoneClick").click(function () {
                ...
                $.post("${path}/user/checksendm?phone=" + $("#phonenumber").val(), function (data) {
                    console.log("返回");
                    console.log(data);
...
<div class="modal-dialog" style="margin-top: 10%;">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h1 class="modal-title text-center" id="myModalLabel">申请解冻界面</h1>
        </div>
        <form action="${path}/user/unlock" method="post">
            <div class="modal-body" id="model-body">
                <div class="form-group">
                    <input type="text" class="form-control input-lg" placeholder="请输入用户名" autocomplete="off"
                           name="name">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control input-lg" placeholder="请输入绑定的邮箱" autocomplete="off"
                           name="email">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control input-lg" placeholder="请输入密码" autocomplete="off"
                           name="pwd">
                </div>
                ...
                <h4>请仔细阅读并勾选：</h4><input type="checkbox" name="checkbox">
                <textarea>
                你只有三次解冻机会，三次之后自动销毁一切数据！！！
            </textarea><br>
                <br>
            </div>

            <button type="submit" class="btn btn-primary form-control btn-lg">申请解冻</button>
        </form>
        <div class="modal-footer">
            <div class="form-group list-group">
                <a href="${path}/jsp/front/login.jsp" class="list-group-item ">
                    <button type="button" class="btn  form-control btn-lg" id="log">返回登录</button>
                </a>
            </div>
